...
@section('css')
  <link href="{{ env('APP_URL') }}assets/admin/libs/datatables/dataTables.bootstrap4.css" rel="stylesheet" type="text/css" />
  @endsection
@section('body')
<div class="row">
  <div class="col-12">
...
@endsection
@section('js')
  <script src="{{ env('APP_URL') }}assets/admin/libs/datatables/jquery.dataTables.min.js"></script>
  <script src="{{ env('APP_URL') }}assets/admin/libs/datatables/dataTables.bootstrap4.min.js"></script>
