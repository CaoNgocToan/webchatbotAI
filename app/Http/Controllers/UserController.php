...
class UserController extends Controller {
    private static $roles = array('Admin' => 'Quản trị', 'Manager' => 'Quản lý', 'Customer' => 'Người dùng');
    ...
    function edit(Request $request, $id = null){
      ...
      return view('Admin.User.edit', ['user' => $user, 'address' => $address,'address_1' => $address_1,'address_2' => $address_2, 'roles' => self::$roles, 'url' => $url]);
    }
